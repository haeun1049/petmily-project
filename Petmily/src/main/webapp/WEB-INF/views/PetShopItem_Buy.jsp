...
<body>
	...
	<div class="buy">
		...
		<strong>배송비</strong><input type="hidden" id="delivery" value=20000>&nbsp;2000원
		</div>
		<br>
		</div>
		...
		<br>
					<div class="Information">
					<strong>이름</strong>&nbsp;<input type="text" value="${member.name}" readonly><br>
					<strong>배송주소</strong>&nbsp;<input type="text" class="address" value="${member.address}" readonly><br>
			...
			<hr>
			<br>
			<div class="pricetotal"><strong>상품 가격</strong> &nbsp;${item.item_price}원 + <strong>배송비</strong>&nbsp;2000원 = ${totalPrice}원</div>
			<br>
			<hr>
			<br>
