...
<br>
 ...
 <!-- ##### Breadcumb Area Start ##### -->
    ...
    <div class="cool-facts-area section-padding-100-0 bg-img background-overlay" style="background-image: url(${pageContext.request.contextPath}/resources/logo/mainlogo.png);">
        <div class="container">
            <div class="row">
                <div class="col-12">
