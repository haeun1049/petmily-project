...
<form action="admin_pet_writ" method="post" enctype="multipart/form-data" class="petwrite">
<table>
<tr><td>
<div id="dog__">
<b>펫 종류 : </b>
...
<br>
 ...
 <tr><td><b>생후 개월수 :</b><input type="text" name ="pet_live"></td></tr><br>
 <tr><td><b>분양가 :</b> <input type="text" name ="pet_price"><br>
...
<tr><td> <b>프로필 사진 : </b><input type="file" name ="pet_profile_file" id ="pet_profile_file"
 ...
 <div style="text-align:center; margin:0 0 100px 0; background:whilt; line-height:60px;">
<tr><td>  <b>이미지 :</b> <input type="file" name ="pet_img_file" id ="pet_img_file"
 style= "width:500px;" onchange="fileInfo2(this)"><br>
 <div id="img_box"></div></td></tr>
 </div>
 
<tr><td> <b>펫 소개 동영상 링크</b> <br>
 <input type="text" name ="pet_trailer"></td></tr><br>
 <tr><td><b>펫 소개글 :</b>
 <br><textarea rows="8" cols="80" name ="pet_contents" placeholder="소개내용"></textarea></td></tr><br>
<tr><td><b>펫 접종 :</b>  <input type="text" name ="pet_inoculation"></td></tr><br><br>
 <tr><td> <input type="submit" value="작성하기" class="inputBtn"></td></tr><br>
  </div>
  </table>
</form>
<br>
